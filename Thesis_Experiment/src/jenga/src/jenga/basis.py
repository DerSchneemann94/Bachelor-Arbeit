...
class Task(ABC):
    def __init__(
        ...
        categorical_feature_encoder_name :str = "one_hot_encode",
        categorical_feature_encoder: BaseEstimator = OneHotEncoder,
    ):
        """
        ...
        self._seed = seed
        self.categorical_feature_encoder_name = categorical_feature_encoder_name
    ...
    def fit_baseline_model(self, train_data: Optional[pd.DataFrame] = None, train_labels: Optional[pd.Series] = None) -> BaseEstimator:
        ...
        categorical_preprocessing = Pipeline(
            [
                ...
                (self.categorical_feature_encoder_name, self.categorical_feature_encoder())
            ]
        )
...
class RegressionTask(Task):
    ...
    def score_on_test_data(self, predictions: pd.array) -> float:
        ...
        return mean_absolute_error(self.test_labels, predictions), mean_squared_error(self.test_labels, predictions), math.sqrt(mean_squared_error(self.test_labels, predictions))
