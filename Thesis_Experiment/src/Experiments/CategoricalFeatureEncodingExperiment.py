...
import joblib
import pandas as pd
from Thesis_Experiment.src.data_imputation_paper.evaluation import EvaluationResult, MultipleColumnsAllMissingEvaluator, MultipleColumnsEvaluator, SingleColumnAllMissingEvaluator, SingleColumnEvaluator
from Thesis_Experiment.src.data_imputation_paper.imputation.utils import set_seed
...
class CategoricalFeatureEncodingExperiment(object):
    ...
    def __init__(
        ...
        categorical_feature_encoder_name = self._categorical_feature_encoder.__class__.__name__
        self._base_path = self._base_path / self._timestamp / categorical_feature_encoder_name
