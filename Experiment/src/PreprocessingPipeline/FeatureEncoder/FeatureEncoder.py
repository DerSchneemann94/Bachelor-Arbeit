...
class FeatureEncoder:
    @staticmethod
    def getCategoricalEncoder(categorical_encoder_name: str) -> EncoderInterface:
        try:   
    ...
    @staticmethod
    def getNumericalEncoder(numerical_encoder_name: str) -> EncoderInterface:
        try:   
    ...
    def transform_data(encoder_name: str, dataframe, encoding_schemes) -> pd.DataFrame:
        try: 
            ...
            encoder = FeatureEncoder.getNumericalEncoder(encoder_name)
